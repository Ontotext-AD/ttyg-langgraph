...
def run_agent_for_evaluation(
    ...
    """
    Runs an agent over a given question and returns the output as expected by the evaluation library https://github.com/Ontotext-AD/qa-eval.
    ...
    :return: check https://github.com/Ontotext-AD/qa-eval documentation for the expected keys in the result
    :rtype: dict[str, Any]
    """
    try:
